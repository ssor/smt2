...
var $author$project$Sku$decodeSkuListFromString = function (s) {
	var _v0 = A2(
		...
		$elm$json$Json$Decode$list($author$project$Sku$skuDecoder),
		s);
	if (_v0.$ === 'Err') {
		return _List_Nil;
	} else {
...
var $author$project$OrderPrepare$defaultGiftList = _List_fromArray(
	['纤维布', '加长螺丝', '铜箔纸包装']);
var $author$project$OrderPrepare$OrderPrepare = F7(
	function (productId, count, sku, itemsForNewOrder, currentGift, giftList, giftCount) {
		return {count: count, currentGift: currentGift, giftCount: giftCount, giftList: giftList, itemsForNewOrder: itemsForNewOrder, productId: productId, sku: sku};
	});
...
var $author$project$OrderPrepare$initOrderPrepare = function () {
	var gift = $elm$core$List$head($author$project$OrderPrepare$defaultGiftList);
	return A7($author$project$OrderPrepare$OrderPrepare, '', 1, $elm$core$Maybe$Nothing, _List_Nil, gift, _List_Nil, 0);
}();
var $elm$core$Debug$log = _Debug_log;
var $author$project$App$initialModel = function (skuRaw) {
	var skuList = function () {
		var _v0 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$string, skuRaw);
		if (_v0.$ === 'Err') {
			var info = _v0.a;
			var _v1 = A2($elm$core$Debug$log, 'parse failed for ', info);
			return _List_Nil;
		} else {
			var jsonRawString = _v0.a;
...
var $author$project$App$init = function (flags) {
	return _Utils_Tuple2(
		$author$project$App$initialModel(flags),
...
var $author$project$App$subscriptions = function (_v0) {
	return A2($elm$time$Time$every, 1000, $author$project$Model$Tick);
};
...
var $author$project$Model$PageSkuList = {$: 'PageSkuList'};
...
var $author$project$Page$NewOrder$addGiftToOrder = function (model) {
	...
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{
				newOrderPrepare: _Utils_update(
					prepare,
					{giftList: newGiftList})
			}),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Order$Item = F2(
	function (sku, count) {
		return {count: count, sku: sku};
	});
var $author$project$OrderPrepare$saveItemToOrderPrepare = function (op) {
	var _v0 = op.sku;
	if (_v0.$ === 'Nothing') {
		return op;
	} else {
		...
		return _Utils_update(
			emptyOp,
			{giftList: op.giftList, itemsForNewOrder: items});
	}
};
var $author$project$Page$NewOrder$addNewItemToOrder = function (model) {
	var prepare = $author$project$OrderPrepare$saveItemToOrderPrepare(model.newOrderPrepare);
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{newOrderPrepare: prepare}),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Page$NewOrder$deleteGift = F2(
	function (name, model) {
		var prepare = model.newOrderPrepare;
		var filter = function (gift) {
			if (gift.$ === 'Nothing') {
				return false;
			} else {
				var value = gift.a;
				return _Utils_eq(value, name) ? false : true;
			}
		};
		var currentGiftList = prepare.giftList;
		var newGiftList = A2($elm$core$List$filter, filter, currentGiftList);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
...
var $author$project$Page$NewOrder$deleteOrderItem = F2(
	function (code, model) {
		var prepare = model.newOrderPrepare;
		var filter = function (item) {
			return _Utils_eq(item.sku.code, code) ? false : true;
		};
		var currentItems = prepare.itemsForNewOrder;
		var newItemList = A2($elm$core$List$filter, filter, currentItems);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$string(sku.code)),
				_Utils_Tuple2(
				'name',
...
var $author$project$Page$SkuList$saveSkuListToLocalStorage = function (skuList) {
	return $author$project$Ports$storeSkuList(
		A2(
			$elm$json$Json$Encode$encode,
			0,
			A2($elm$json$Json$Encode$list, $author$project$Sku$skuEncoder, skuList)));
};
...
var $author$project$Page$SkuList$parseSkuListInCsv = F2(
	function (content, model) {
		var result = $periodic$elm_csv$Csv$parse(content);
		var skuList = function () {
			if (result.$ === 'Ok') {
				var obj = result.a;
				return A2($elm$core$List$filterMap, $author$project$Sku$skuFromStringArray, obj.records);
			} else {
				return _List_Nil;
			}
		}();
		var _v0 = A2($elm$core$Debug$log, 'csv content:', content);
		var _v1 = A2($elm$core$Debug$log, 'parse result: ', result);
		var _v2 = A2($elm$core$Debug$log, 'convert to sku: ', skuList);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{skuList: skuList}),
			$author$project$Page$SkuList$saveSkuListToLocalStorage(skuList));
	});
var $author$project$Page$SkuList$patchPostSkuResponse = F2(
	function (result, model) {
		if (result.$ === 'Err') {
			var info = result.a;
			var _v1 = A2($elm$core$Debug$log, 'batch post sku failed: ', info);
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Page$NewOrder$productCountInOrderChanged = F2(
	function (model, value) {
		var prepared = model.newOrderPrepare;
		var count = A2(
			$elm$core$Maybe$withDefault,
			1,
...
var $author$project$Page$NewOrder$searchProductById = F2(
	function (model, value) {
		var skuAfterFilter = A2(
			$elm$core$List$filter,
			function (sku) {
				return _Utils_eq(sku.code, value);
			},
			model.skuList);
		var prepared = model.newOrderPrepare;
		var _v0 = A2($elm$core$Debug$log, 'product id changed', value);
		var _v1 = A2(
			$elm$core$Debug$log,
			'filter: ',
			$elm$core$List$head(skuAfterFilter));
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					newOrderPrepare: _Utils_update(
						...
						{
							productId: value,
							sku: $elm$core$List$head(skuAfterFilter)
						})
				}),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$App$skuDataReceived = F2(
...
var $author$project$Model$PageAddOrder = {$: 'PageAddOrder'};
var $author$project$App$toAddOrderPage = function (model) {
	var _v0 = A2($elm$core$Debug$log, 'orders: ', model.orderList);
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{newOrderPrepare: $author$project$OrderPrepare$initOrderPrepare, page: $author$project$Model$PageAddOrder}),
		$elm$core$Platform$Cmd$none);
};
var $elm$file$File$toString = _File_toString;
var $author$project$App$updateTick = F2(
...
var $author$project$App$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Tick':
				var posix = msg.a;
				return A2($author$project$App$updateTick, posix, model);
			case 'ToAddOrderPage':
					...
					_Utils_update(
						model,
						{
							newOrderPrepare: _Utils_update(
								prepare,
								{
									currentGift: $elm$core$Maybe$Just(v)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'AddGiftToOrder':
				return $author$project$Page$NewOrder$addGiftToOrder(model);
			case 'DeleteGift':
				var name = msg.a;
				return A2($author$project$Page$NewOrder$deleteGift, name, model);
			case 'PrintOrder':
				return $author$project$Page$NewOrder$handlePrintOrder(model);
			case 'ResetOrder':
				return $author$project$Page$NewOrder$resetOrder(model);
			case 'ToShowSkuListPage':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{page: $author$project$Model$PageSkuList}),
					$elm$core$Platform$Cmd$none);
			case 'SkuDataReceived':
				var response = msg.a;
				return A2($author$project$App$skuDataReceived, model, response);
			case 'SearchProductById':
				var value = msg.a;
				return A2($author$project$Page$NewOrder$searchProductById, model, value);
			case 'ProductCountInOrderChanged':
				var value = msg.a;
				return A2($author$project$Page$NewOrder$productCountInOrderChanged, model, value);
			case 'CsvRequested':
				return _Utils_Tuple2(
					model,
					A2(
			...
			case 'CsvLoaded':
				var content = msg.a;
				return A2($author$project$Page$SkuList$parseSkuListInCsv, content, model);
			default:
				var response = msg.a;
				return A2($author$project$Page$SkuList$patchPostSkuResponse, response, model);
		}
	});
...
var $author$project$Page$NewOrder$inputProductEmpty = function (count) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Page$NewOrder$inputForOrderItems = function (model) {
	var prepare = model.newOrderPrepare;
	var _v0 = prepare.sku;
	if (_v0.$ === 'Nothing') {
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Model$DeleteGift(value)),
							A2($elm$html$Html$Attributes$style, 'font-size', '13px'),
							A2($elm$html$Html$Attributes$style, 'text-decoration', 'underline')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('删除')
						]))
				]));
	}
};
var $author$project$Model$DeleteOrderItem = function (a) {
	return {$: 'DeleteOrderItem', a: a};
};
var $author$project$Page$NewOrder$inputForOrderItem = function (item) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Page$NewOrder$orderItemsTableBody = function (prepare) {
	var skuList = A2($elm$core$List$map, $author$project$Page$NewOrder$inputForOrderItem, prepare.itemsForNewOrder);
...
var $author$project$Page$SkuList$skuItemTableBody = function (sku) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$tbody,
						_List_Nil,
						A2($elm$core$List$map, $author$project$Page$SkuList$skuItemTableBody, model.skuList))
					]))
			]));
};
var $author$project$App$mainContentView = function (model) {
	var _v0 = model.page;
	switch (_v0.$) {
		case 'PageHome':
			return A2(
...
var $author$project$App$columnsView = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$App$menuView(model)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$author$project$App$mainContentView(model)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$App$topLayout = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$App$columnsView(model)
			]));
};
var $author$project$App$view = function (model) {
	return $author$project$App$topLayout(model);
};
